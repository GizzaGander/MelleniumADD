 ...
 */
public class RenderTool2 implements IItemRenderer {
    ...
    public RenderTool2(String model, String texture, IRenderTweak tool) {
        this.tool = tool;
        this.toolModel = AdvancedModelLoader.loadModel(ResourceHandler2.getResource(model));
    ...
    public void renderItem(ItemRenderType type, ItemStack item, Object... data) {
        GL11.glPushMatrix();
        ResourceHandler2.bindResource(toolTexture);

 ...
 */
public class ModelChaoticArmorOld extends ModelBiped {//
...
//    public ModelRenderer bipedLeftLeg;
    ...
    public ModelChaoticArmorOld(float f, boolean isHelmet, boolean isChestPiece, boolean isLeggings, boolean isdBoots, boolean isDraconic) {

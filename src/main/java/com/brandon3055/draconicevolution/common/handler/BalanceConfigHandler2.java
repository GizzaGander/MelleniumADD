...
public class BalanceConfigHandler2 {
    ...
    public static final int chaoticToolsMaxDigDepthUpgradePoints = 4;
    ...
    public static int chaoticArmorMaxUpgrades = 12;
    ...
    public static int chaoticCapacitorMaxUpgrades = 15;

...
public class BalanceConfigHandler2 {
    ...
    public static final int chaoticToolsMinDigAOEUpgradePoints = 3;
    public static final int chaoticToolsMaxDigAOEUpgradePoints = 6;
    ...
    public static final int chaoticToolsMinDigDepthUpgradePoints = 3;
    public static final int chaoticToolsMaxDigDepthUpgradePoints = 6;
    ...
    public static final int chaoticBowMaxArrowDamageUpgradePoints = 100;
    ...
    public static int chaoticCapacitorMaxUpgrades = 25;

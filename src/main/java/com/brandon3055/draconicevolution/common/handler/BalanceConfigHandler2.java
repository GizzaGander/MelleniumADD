...
public class BalanceConfigHandler2 {
    ...
    public static int chaoticCapacitorStoragePerUpgrade = 90000000;
    public static int chaoticCapacitorMaxReceive = 100000000;
    public static int chaoticCapacitorMaxExtract = 1000000000;
    public static int chaoticWeaponsBaseStorage = 100000000;

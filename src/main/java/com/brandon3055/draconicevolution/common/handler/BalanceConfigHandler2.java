...
public class BalanceConfigHandler2 {
    ...
    public static final int chaoticStaffMinDigAOEUpgradePoints = 3;
    public static final int chaoticStaffMaxDigAOEUpgradePoints = 5;
    public static final int chaoticStaffMinDigDepthUpgradePoints = 7;
    public static final int chaoticStaffMaxDigDepthUpgradePoints = 11;
    public static final int chaoticStaffMinAttackAOEUpgradePoints = 3;
    ...
    public static int chaoticCapacitorBaseStorage = 250000000;
    public static int chaoticCapacitorStoragePerUpgrade = 50000000;
    public static int chaoticCapacitorMaxReceive = 10000000;
    public static int chaoticCapacitorMaxExtract = 100000000;
    public static int chaoticWeaponsBaseStorage = 10000000;
    public static int chaoticWeaponsStoragePerUpgrade = 5000000;
    public static int chaoticWeaponsMaxTransfer = 500000;
    public static int chaoticWeaponsEnergyPerAttack = 250;
    public static int chaoticBowEnergyPerShot = 80;
    public static int chaoticFireEnergyCostMultiptier = 30;
    ...
    public static int chaoticCapacitorMaxUpgrades = 6;

package com.Mellenium.Addons.client.render;
...
public class RenderTileDecrypter extends TileEntitySpecialRenderer {
    ...
    public void renderTileEntityAt(TileEntity tileEntity, double x, double y, double z, float f) {
        ...
        TileDecrypter tile = (TileDecrypter) tileEntity;
        renderBlock(tile, tileEntity.getWorldObj(), tileEntity.xCoord, tileEntity.yCoord, tileEntity.zCoord, f);

        GL11.glPopMatrix();
    }

    public void renderBlock(TileDecrypter tile, World world, int x, int y, int z, float f) {
    ...
    public void renderItem(TileDecrypter tile, int i, float f, boolean rotate) {
